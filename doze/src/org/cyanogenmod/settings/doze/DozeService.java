...
public class DozeService extends Service {
    ...
    private boolean isDozeEnabled() 
	{
		...
		{
			if (DEBUG) Log.d(TAG, "isDozeEnabled() doze disabled");
			return false;
		}
		if (SystemProperties.get("persist.sys.ts.psen_en_b", "0").equals("0"))
		{
			if (DEBUG) Log.d(TAG, "isDozeEnabled() pickup sensor disabled");
			return false;
		}
		return true;
    }
